...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-kapacitor:${tag}" "asia.gcr.io/orange-sys/alpine-kapacitor:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-kapacitor:${tag}
